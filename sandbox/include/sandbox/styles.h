...
public:
    static void setupDarkTheme() {
        ...
        colors[ImGuiCol_CheckMark]              = ImVec4(0.86f, 0.56f, 0.37f, 1.00f);
        ...
        colors[ImGuiCol_ResizeGripHovered]      = ImVec4(0.39f, 0.30f, 0.12f, 0.67f);
        colors[ImGuiCol_ResizeGripActive]       = ImVec4(0.71f, 0.40f, 0.06f, 0.95f);
        colors[ImGuiCol_InputTextCursor]        = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
        colors[ImGuiCol_TabHovered]             = ImVec4(0.29f, 0.29f, 0.29f, 0.80f);
        colors[ImGuiCol_Tab]                    = ImVec4(0.18f, 0.18f, 0.18f, 0.86f);
        colors[ImGuiCol_TabSelected]            = ImVec4(0.78f, 0.49f, 0.12f, 1.00f);
        colors[ImGuiCol_TabSelectedOverline]    = ImVec4(0.48f, 0.48f, 0.48f, 1.00f);
